...
export const PLAN_SYSTEM = [CORE, rules.property, rules.calendar, rules.fire, rules.gatherings,
  ...
  "Plans are intentions, not execution or obligations. Current physical needs override them. Vacancies require apply; work needs a held job, the right place/hours and a working day. Procedures must be practiced; merely proposing one does nothing.",
